...
include(dirname(__DIR__, 1).DIRECTORY_SEPARATOR.'Model'.DIRECTORY_SEPARATOR.'solicitacaoModel.php');
	...
	class solicitacaoController{
		...
		function solicitarEmprestimo($equipamentos=null, $data_inicio=null, $data_fim=null, $solicitante=null, $nome_atividade=null, $destino=null, $observacao=null){
			$solicitacaoModel = new solicitacaoModel();
			$resultado = $solicitacaoModel->solicitarEmprestimoModel($equipamentos, $data_inicio, $data_fim, $solicitante, $nome_atividade, $destino, $observacao);
