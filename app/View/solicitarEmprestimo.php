    ...
    <div class="card shadow-lg border-0">
      ...
      <div class="card-body">
        <form action="../Action/solicitarEmprestimo.php" method="POST" id="formulario">
          ...
          <div class="row mt-3">
                <div class="col">
                    <strong>Descreva livremente sobre sua necessidade ou busque os equipamentos no  outro campo:</strong> 
                    <textarea name="observacao" class="form-control" ></textarea>
                </div>
            </div>
          <div class="row mt-3">
            <strong>Busque equipamentos para empréstimo:</strong>
            <input type="text" id="busca-equipamento" name="busca-equipamento" class="form-control" placeholder="Digite algo para buscar..." autocomplete="off">
  ...
  <script>
    ...
    $(document).ready(function() {
      $('#busca-equipamento').keyup(function() {
        ...
        if (busca.length >= 2) {
          $.ajax({
            url: '../Model/buscarEquipamentosParaSolicitacao.php',
            type: 'POST',
            data: { 
              busca: busca,
