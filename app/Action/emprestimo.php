...
include(dirname(__DIR__, 1).DIRECTORY_SEPARATOR.'Controller'.DIRECTORY_SEPARATOR.'emprestimoController.php');
 	...
 	if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['codigoDeBarras']) && isset($_POST['nome_solicitante'])) {
		...
		$id_emprestimo++;
 			...
 			$emprestimo->emprestarEquipamento($codigo_de_barras, $nome_equipamento, $_POST['nome_solicitante'], $_POST['cpf_solicitante'], $id_emprestimo, $_POST['data_inicio_emprestimo'], $_POST['data_fim_emprestimo'], $_POST['destino'], $_POST['nome_atividade'], $_POST['solicitacao']);
