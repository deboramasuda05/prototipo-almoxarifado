# 📦 Sistema de Almoxarifado - Gestão de Estoque
...
Tabela	Descrição
usuarios	Dados de acesso e permissões
equipamentos	Catálogo de equipamentos do almoxarifado
emprestimos	Registro de todas as transações
...
Polos: Cachoeira Paulista | Caçapava | Ilhabela | São José dos Campos | Tremembé

Curso: Engenharia da Computação / Bacharelado em Tecnologia da Informação 
