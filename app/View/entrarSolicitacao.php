    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <strong>Status:</strong> <?= ($resultado[0][0]['status'] == 'Aprovada') ? '<span class="badge bg-success">APROVADO</span>': '<span class="badge bg-warning text-dark">PENDENTE</span>'  ;  ?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    <textarea name="observacao" class="form-control" readonly ><?= $resultado[0][0]['observacao']; ?></textarea>
                </div>
            </div>
        </div>
    </div>
